...
```shell
$ cd toCKB
$ ./target/release/btc-proof-generator-by-rpc mint-xt --tx-hash $BTC_TX_HASH --funding-input-index 0 --funding-output-index 0
```
...
```shell
$ cd toCKB
$ ./target/release/btc-proof-generator-by-rpc mint-xt --tx-hash $BTC_TX_HASH --funding-input-index 1 --funding-output-index 1
```
