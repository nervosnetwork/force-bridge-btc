...
#[derive(Clone)]
pub struct Bytes2(molecule::bytes::Bytes);
impl ::core::fmt::LowerHex for Bytes2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl ::core::fmt::Debug for Bytes2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl ::core::fmt::Display for Bytes2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl ::core::default::Default for Bytes2 {
    fn default() -> Self {
        let v: Vec<u8> = vec![4, 0, 0, 0];
        Bytes2::new_unchecked(v.into())
    }
}
impl Bytes2 {
    pub fn total_size(&self) -> usize {
    ...
    pub fn as_reader<'r>(&'r self) -> Bytes2Reader<'r> {
        Bytes2Reader::new_unchecked(self.as_slice())
    }
}
impl molecule::prelude::Entity for Bytes2 {
    type Builder = Bytes2Builder;
    ...
    fn from_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        Bytes2Reader::from_slice(slice).map(|reader| reader.to_entity())
    }
    fn from_compatible_slice(slice: &[u8]) -> molecule::error::VerificationResult<Self> {
        Bytes2Reader::from_compatible_slice(slice).map(|reader| reader.to_entity())
    }
    fn new_builder() -> Self::Builder {
        ::core::default::Default::default()
    }
...
#[derive(Clone, Copy)]
pub struct Bytes2Reader<'r>(&'r [u8]);
impl<'r> ::core::fmt::LowerHex for Bytes2Reader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        use molecule::hex_string;
        if f.alternate() {
            write!(f, "0x")?;
...
impl<'r> ::core::fmt::Debug for Bytes2Reader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{}({:#x})", Self::NAME, self)
    }
}
impl<'r> ::core::fmt::Display for Bytes2Reader<'r> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(f, "{} [", Self::NAME)?;
        for i in 0..self.len() {
            if i == 0 {
...
impl<'r> molecule::prelude::Reader<'r> for Bytes2Reader<'r> {
    type Entity = Bytes2;
    const NAME: &'static str = "Bytes2Reader";
    fn to_entity(&self) -> Self::Entity {
        Self::Entity::new_unchecked(self.as_slice().to_owned().into())
    }
    fn new_unchecked(slice: &'r [u8]) -> Self {
...
#[derive(Debug, Default)]
pub struct Bytes2Builder(pub(crate) Vec<Bytes>);
impl Bytes2Builder {
...
impl molecule::prelude::Builder for Bytes2Builder {
    type Entity = Bytes2;
    const NAME: &'static str = "Bytes2Builder";
    fn expected_length(&self) -> usize {
    ...
    fn build(&self) -> Self::Entity {
        ...
        self.write(&mut inner)
            .unwrap_or_else(|_| panic!("{} build should be ok", Self::NAME));
        Bytes2::new_unchecked(inner.into())
    }
}
pub struct Bytes2Iterator(Bytes2, usize, usize);
impl ::core::iter::Iterator for Bytes2Iterator {
    type Item = Bytes;
    fn next(&mut self) -> Option<Self::Item> {
        if self.1 >= self.2 {
            None
...
impl ::core::iter::ExactSizeIterator for Bytes2Iterator {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
impl ::core::iter::IntoIterator for Bytes2 {
    type Item = Bytes;
    type IntoIter = Bytes2Iterator;
    fn into_iter(self) -> Self::IntoIter {
        let len = self.len();
        Bytes2Iterator(self, 0, len)
    }
}
impl<'r> Bytes2Reader<'r> {
    pub fn iter<'t>(&'t self) -> Bytes2ReaderIterator<'t, 'r> {
        Bytes2ReaderIterator(&self, 0, self.len())
    }
}
pub struct Bytes2ReaderIterator<'t, 'r>(&'t Bytes2Reader<'r>, usize, usize);
impl<'t: 'r, 'r> ::core::iter::Iterator for Bytes2ReaderIterator<'t, 'r> {
...
impl<'t: 'r, 'r> ::core::iter::ExactSizeIterator for Bytes2ReaderIterator<'t, 'r> {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}
